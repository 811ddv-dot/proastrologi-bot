...
Каждый из 12 текстов должен отличаться не только словами, но и конфликтом, местом, действием, настроением и финалом. Используй в выпуске ровно по одному сюжету: личная встреча, работа, дом, деньги, дорога, покупка, семья, учёба, творчество, план, переписка, выбор. Не меняй местами один и тот же шаблон.
