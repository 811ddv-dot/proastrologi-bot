...
какие обстоятельства вероятны, что будет даваться легче или сложнее, что это
может изменить в делах или общении. Допустим один уместный совет, не цепочка наставлений.
